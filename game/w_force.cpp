...
int ForcePowerUsableOn( gentity_t *attacker, gentity_t *other, forcePowers_t forcePower ) {
	...
	//Я в сейф-зоне!!
	if (other->client->ps.iamfriendly || other->client->ps.iamunforcer)
		return 0;
	...
	if ( other && other->client && other->client->ps.duelInProgress && !(other->duelFullForce)) { // && (attacker->client->ps.duelIndex == other->s.number)
		return 0;
	}
	if (((other->duelFullForce && !attacker->duelFullForce) || (attacker->duelFullForce && !other->duelFullForce) || (other->duelFullForce && !attacker->client) || (attacker->duelFullForce && !other->client)) && (attacker->client->ps.duelInProgress || other->client->ps.duelInProgress))
	{
		return 0;
	}
	if ((attacker->client->ps.duelInProgress && other->client->ps.duelInProgress) &&(other->duelFullForce && attacker->duelFullForce) && !(attacker->client->ps.duelIndex == other->s.number && other->client->ps.duelIndex == attacker->s.number))
	{
		return 0; 
	}
...
qboolean WP_ForcePowerUsable( gentity_t *self, forcePowers_t forcePower ) {
	...
	//Я в сейф-зоне!!
	if ((self->client->ps.iamfriendly || self->client->ps.iamunforcer) && !(self->client->ps.fd.forcePower == FP_LEVITATION))
		return qfalse;
...
void ForceHeal( gentity_t *self ) {
	...
	*/
	...
	if ((self->client->pers.cmd.upmove == 0) && (self->client->pers.cmd.rightmove == 0) && (self->client->pers.cmd.forwardmove == 0))
	{
		G_SetAnim(self, NULL, SETANIM_BOTH, BOTH_FORCEHEAL_START, SETANIM_FLAG_OVERRIDE | SETANIM_FLAG_HOLD | SETANIM_FLAG_HOLDLESS, 0);
	}
}
...
void ForceProtect( gentity_t *self ) {
	...
	if ((self->client->pers.cmd.upmove == 0) && (self->client->pers.cmd.rightmove == 0) && (self->client->pers.cmd.forwardmove == 0))
	{
		G_SetAnim(self, NULL, SETANIM_BOTH, BOTH_FORCE_PROTECT, SETANIM_FLAG_OVERRIDE | SETANIM_FLAG_HOLD | SETANIM_FLAG_HOLDLESS, 0);
	}
}
...
void ForceAbsorb( gentity_t *self ) {
	...
	if ((self->client->pers.cmd.upmove == 0) && (self->client->pers.cmd.rightmove == 0) && (self->client->pers.cmd.forwardmove == 0))
	{
		G_SetAnim(self, NULL, SETANIM_BOTH, BOTH_FORCE_ABSORB, SETANIM_FLAG_OVERRIDE | SETANIM_FLAG_HOLD | SETANIM_FLAG_HOLDLESS, 0);
	}
}
...
void ForceRage( gentity_t *self ) {
	...
	if ((self->client->pers.cmd.upmove == 0) && (self->client->pers.cmd.rightmove == 0) && (self->client->pers.cmd.forwardmove == 0))
	{
		G_SetAnim(self, NULL, SETANIM_BOTH, BOTH_FORCE_RAGE, SETANIM_FLAG_OVERRIDE | SETANIM_FLAG_HOLD | SETANIM_FLAG_HOLDLESS, 0);
	}
}
		...
		if ( traceEnt->client ) {//an enemy or object
			...
			if ( ForcePowerUsableOn( self, traceEnt, FP_LIGHTNING ) ) {
				...
				if ( self->client->ps.weapon == WP_MELEE
					...
					dmg *= (float)japp_twohandlightningmultiply.integer; //default = 2, coz TWO HANDS
				}
