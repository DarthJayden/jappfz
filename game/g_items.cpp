...
void EWebFire( gentity_t *owner, gentity_t *eweb ) {
	...
	//create the missile
	missile = CreateMissile( &bPoint, &d, (float)japp_ewebvelocity.integer/*1200.0f*/, 10000, owner, qfalse );

	missile->classname = "generic_proj";
	missile->s.weapon = WP_TURRET;

	missile->damage = japp_ewebdamage.integer;
