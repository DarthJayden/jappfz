...
XCVAR_DEF( g_saberRealisticCombat, "0", NULL, CVAR_ARCHIVE/*CVAR_CHEAT*/, qfalse )
...
//Jayden
XCVAR_DEF(japp_e11damage, "20", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_e11velocity, "2300", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_e11spread, "1.6", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_repeaterdamage, "14", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeatervelocity , "1600", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeaterspread, "1.4", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeateraltsize, "3", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeateraltdamage, "60", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeateraltsplashdamage, "60", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeateraltsplashradius, "128", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_repeateraltvelocity, "1100", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_demp2velocity, "1800", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_demp2damage, "35", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_demp2size, "2", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_demp2altdamage, "8", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_demp2chargeunit, "700.0", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_demp2altrange, "4096", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_demp2splashradius, "256", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_rocketvelocity, "900", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_rocketdamage, "100", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_rocketsplashdamage, "100", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_rocketsplashradius, "160", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_rocketsize, "3", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_rocketaltthinktime, "100", NULL, CVAR_ARCHIVE, qtrue)
/* There should be emplaced cvars
XCVAR_DEF(japp_turretlifetime, "60000", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_turretsplashradius, "100", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_turretdamage, "10", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_turretCustomDamage, "0", NULL, CVAR_ARCHIVE, qtrue)
*/
XCVAR_DEF(japp_ewebdamage, "20", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_ewebvelocity, "1200", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_bowcasterdamage, "50", NULL, CVAR_ARCHIVE, qtrue)
XCVAR_DEF(japp_bowcastervelocity, "1300", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_allowgoto, "0", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_twohandlightningmultiply, "2.0", NULL, CVAR_ARCHIVE, qtrue)

XCVAR_DEF(japp_allmodelsallowed, "0", NULL, CVAR_ARCHIVE, qtrue) //Все ли мечи и модели доступы? Если 1, то можно составлять списки и запрещать определенные клинки всем, кроме кого-то.
